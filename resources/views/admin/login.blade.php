...
<head>
    ...
    <link rel="stylesheet" href="{{asset('topjui/static/plugins/bootstrap/css/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{asset('topjui/static/plugins/font-awesome/css/font-awesome.min.css')}}">
    <style type="text/css">
        html, body {
            height: 100%;
        }
        ...
        .box {
            background: url("{{asset('topjui/topjui/images/loginBg.jpg')}}") no-repeat center center;
...
<!-- 引入jQuery -->
<script src="{{asset('topjui/static/plugins/jquery/jquery.min.js')}}"></script>
<script src="{{asset('topjui/static/plugins/jquery/jquery.cookie.js')}}"></script>
<script src="{{asset('topjui/static/plugins/bootstrap/js/bootstrap.min.js')}}}"></script>
<!-- HTML5 shim and Respond.js for IE8 support of HTML5 elements and media queries -->
<!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
<!--[if lt IE 9]>
<script src="{{asset('topjui/static/plugins/bootstrap/plugins/html5shiv.min.js')}}"></script>
<script src="{{asset('topjui/static/plugins/bootstrap/plugins/respond.min.js')}}"></script>
<![endif]-->
